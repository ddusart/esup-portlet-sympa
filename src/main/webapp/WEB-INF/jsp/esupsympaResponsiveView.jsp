...
<form method="post" class="c" action="<c:out value="${actionURL}" escapeXml="true"/>">
	<div class="row">
		...
		<div class="col-lg-2">
			<span class="checkbox"> <spring:bind
					path="searchForm.subscriber">
					<c:choose>
		...
		<div class="col-lg-2">
			<span class="checkbox"> <spring:bind path="searchForm.owner">
					<c:choose>
						<c:when test="${status.value == true}">
							<input type="checkbox" name="${status.expression}" value="true"
								id="${namespace}_${status.expression}" checked="checked" />
		...
		<div class="col-lg-2">
			<span class="checkbox"> <spring:bind path="searchForm.editor">
					<c:choose>
						<c:when test="${status.value == true}">
							<input type="checkbox" name="${status.expression}" value="true"
								id="${namespace}_${status.expression}" checked="checked" />
